...
// Commenting lines 297 and 298 to force the router to navigate to an url even if it is equal to the current url. - Carlos
    ...
    var History = kendo.Observable.extend({
        ...
        _navigate: function(to, silent, callback) {
            ...
            if (this.current === to || this.current === decodeURIComponent(to)) {
                // Commenting these two lines to force the router to navigate to an url even if it is equal to the current url. - Carlos
                //this.trigger(SAME);
                //return;
                console.log("router.js - Navigating to current URL, this will refresh the current spa page. - Carlos");
            }
