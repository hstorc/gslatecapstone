    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            var scriptBundle = new ScriptBundle("~/bundles/all").Include(
                    // 3rd party scripts                   
                    "~/3rdParty/jquery/js/jquery-1.9.1.js",

                     "~/3rdParty/Kendo-UI-Professional-3-1111-2015/js/kendo.all.js",
                    ...
                    "~/spa/Global/bindView.js",
                    "~/spa/Global/globalShims.js",
                    "~/SPA/Util/layout.js",
                    "~/SPA/Router.js",
                    "~/SPA/App.js",
                    "~/SPA/Global/globalVariables.js",
                    "~/SPA/Global/notifications.js",                    
